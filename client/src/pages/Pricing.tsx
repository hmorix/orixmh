      ...
      <div className="max-w-[1280px] mx-auto px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          {[
            ...
            { plan: 'Professional', price: 'Inr 75,000', period: '/project', desc: 'For growing companies', features: ['Full-stack application','100+ pages','Advanced SEO & analytics','12 months support','CI/CD pipeline','Custom integrations','Priority support','HMorix Product &Services'], cta: 'Get Started', featured: true },
            { plan: 'Enterprise', price: 'Custom', period: '', desc: 'For large organizations', features: ['Multiple applications','Dedicated team','24/7 support','SLA guarantee','Security audits','Custom infrastructure','On-site consulting','HMorix Product &Services'], cta: 'Contact Sales' },
          ].map((plan, i) => (
