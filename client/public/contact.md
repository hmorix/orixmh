...
| :--- | :--- | :--- | :--- |
| **General Inquiries** | info@hmorix.in | < 4 hours (Business hours) | General questions, partnerships, media inquiries |
| **Technical Support** | support@hmorix.in | < 1 hour (24/7 on-call) | Live production issues, API key access, deployment assistance |
| **Executive / Founder** | harsh@hmorix.in | < 4 hours | Strategic partnerships, vendor relations, executive escalations |
| **Careers & Recruitment** | career@hmorix.in | < 2 business days | Job applications, internship enquiries, talent acquisition |
| **Human Resources** | hr@hmorix.in | < 1 business day | Employee matters, payroll queries, HR policies |
| **Legal & Official** | offical@hmorix.in | < 1 business day | Legal notices, compliance, data protection requests |
